...
public class ModelCruiserAtago
extends ShipModelBaseAdv {
    ...
    private final ModelRenderer Hair01a1;
    private final ModelRenderer Hair02;
    private final ModelRenderer Hair01b1;
    private final ModelRenderer Hair01c1;
    private final ModelRenderer Hair01d1;
    private final ModelRenderer Hair01b1_1;
    private final ModelRenderer Hair01c1_1;
    private final ModelRenderer Hair01a2;
    private final ModelRenderer Hair01a3;
    private final ModelRenderer Hair01b2;
    private final ModelRenderer Hair01b3;
    private final ModelRenderer Hair01c2;
    private final ModelRenderer Hair01c3;
    private final ModelRenderer Hair01d2;
    private final ModelRenderer Hair01d3;
    private final ModelRenderer Hair01b2_1;
    private final ModelRenderer Hair01b3_1;
    private final ModelRenderer Hair01c2_1;
    private final ModelRenderer Hair01c3_1;
    ...
    private final ModelRenderer Cloth01d;
    ...
    private final ModelRenderer SkirtIn;
    ...
    public ModelCruiserAtago() {
        ...
        this.setRotateAngle(this.Hair01b2, 0.0f, 0.0f, -0.2617994f);
        ...
        this.setRotateAngle(this.Cloth01a, -0.87266463f, 0.5235988f, 0.17453292f);
        ...
        this.setRotateAngle(this.Cloth01b, -0.87266463f, -0.5235988f, -0.17453292f);
        ...
        this.setRotateAngle(this.Hair01b1, 0.2617994f, -0.87266463f, -0.6981317f);
        ...
        this.setRotateAngle(this.Hair01a2, 0.0f, 0.0f, -0.34906584f);
        ...
        this.setRotateAngle(this.Hair01c1_1, 0.6981317f, 0.7853982f, 0.9599311f);
        ...
        this.setRotateAngle(this.EquipBag00, 0.2617994f, 1.3962634f, 0.08726646f);
        ...
        this.setRotateAngle(this.Hair01c1, 0.6981317f, -0.7853982f, -0.9599311f);
        ...
        this.setRotateAngle(this.Hair01b3, 0.0f, 0.0f, 1.3089969f);
        ...
        this.setRotateAngle(this.Hair01b1_1, 0.2617994f, 0.87266463f, 0.6981317f);
        ...
        this.setRotateAngle(this.Hair01c3, 0.0f, 0.0f, 1.0471976f);
        ...
        this.setRotateAngle(this.Skirt03, 0.091106184f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.Hair02, 0.2617994f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.Hair01b3_1, 0.0f, 0.0f, -1.3089969f);
        ...
        this.setRotateAngle(this.Hair01a3, 0.0f, 0.0f, 1.0471976f);
        ...
        this.setRotateAngle(this.Hair01d2, 0.0f, 0.0f, 0.34906584f);
        ...
        this.Hat02.addBox(-4.0f, 0.0f, -4.0f, 8, 3, 8, 0.0f);
        ...
        this.setRotateAngle(this.Cloth01d, -0.5934119f, -0.2617994f, 0.0f);
        ...
        this.setRotateAngle(this.Hair01c2, 0.0f, 0.0f, 0.2617994f);
        ...
        this.setRotateAngle(this.Skirt01, -0.06981317f, 0.0f, 0.0f);
        ...
        this.Hat01.addBox(-3.5f, 0.0f, -3.5f, 7, 2, 7, 0.0f);
        this.setRotateAngle(this.Hat01, -0.2618f, 0.0f, 0.1745f);
        ...
        this.setRotateAngle(this.Hair01d1, -0.08726646f, 1.0471976f, 0.5235988f);
        ...
        this.setRotateAngle(this.Hair01c2_1, 0.0f, 0.0f, -0.2617994f);
        ...
        this.setRotateAngle(this.Hair01c3_1, 0.0f, 0.0f, -1.0471976f);
        ...
        this.setRotateAngle(this.Hair01a1, -0.08726646f, -1.0471976f, -0.5235988f);
        ...
        this.setRotateAngle(this.Hair01d3, 0.0f, 0.0f, -1.0471976f);
        ...
        this.setRotateAngle(this.Cloth01c, -0.61086524f, 0.2617994f, 0.0f);
        ...
        this.setRotateAngle(this.Hair01b2_1, 0.0f, 0.0f, 0.2617994f);
        ...
        this.SkirtIn.addBox(-8.0f, 0.0f, -5.0f, 16, 5, 10, 0.0f);
        this.setRotateAngle(this.SkirtIn, -0.2618f, 0.0f, 0.0f);
    ...
    public void applyDeadPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
        GlStateManager.translate(0.0f, 0.58f + 0.26f * ent.getScaleLevel(), 0.0f);
