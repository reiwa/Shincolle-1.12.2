...
public class ModelBattleshipRu
extends ShipModelBaseAdv {
    ...
    private final ModelRenderer Shoe01;
    private final ModelRenderer LegRight02;
    private final ModelRenderer Shoe02;
    private final ModelRenderer ArmRight02;
    private final ModelRenderer EquipRBase;
    ...
    private final ModelRenderer EquipRC04a;
    private final ModelRenderer EquipR02a;
    private final ModelRenderer EquipR03a;
    private final ModelRenderer EquipR04a;
    private final ModelRenderer EquipR05a;
    private final ModelRenderer EquipR06a;
    private final ModelRenderer EquipR07;
    private final ModelRenderer EquipR02b;
    private final ModelRenderer EquipR03b;
    private final ModelRenderer EquipR04b;
    private final ModelRenderer EquipR05b;
    private final ModelRenderer EquipR06b;
    private final ModelRenderer EquipR08;
    private final ModelRenderer EquipR09;
    private final ModelRenderer EquipR10;
    private final ModelRenderer EquipRC01b;
    private final ModelRenderer EquipRC01c;
    private final ModelRenderer EquipRC02b;
    private final ModelRenderer EquipRC03b;
    private final ModelRenderer EquipRC03c;
    private final ModelRenderer ArmLeft02;
    private final ModelRenderer EquipLBase;
    ...
    private final ModelRenderer EquipLC04a;
    private final ModelRenderer EquipL02a;
    private final ModelRenderer EquipL03a;
    private final ModelRenderer EquipL04a;
    private final ModelRenderer EquipL05a;
    private final ModelRenderer EquipL06a;
    private final ModelRenderer EquipL07;
    private final ModelRenderer EquipL02b;
    private final ModelRenderer EquipL03b;
    private final ModelRenderer EquipL04b;
    private final ModelRenderer EquipL05b;
    private final ModelRenderer EquipL06b;
    private final ModelRenderer EquipL08;
    private final ModelRenderer EquipL09;
    private final ModelRenderer EquipL10;
    private final ModelRenderer EquipLC01b;
    private final ModelRenderer EquipLC01c;
    private final ModelRenderer EquipLC02b;
    private final ModelRenderer EquipLC03b;
    private final ModelRenderer EquipLC03c;
    private final ModelRenderer Equip01a;
    private final ModelRenderer Equip01b;
    private final ModelRenderer Equip02;
    private final ModelRenderer Equip03a;
    private final ModelRenderer EquipCB01;
    private final ModelRenderer Equip03b;
    private final ModelRenderer EquipCB03;
    private final ModelRenderer EquipCB02a;
    private final ModelRenderer EquipCB02b;
    private final ModelRenderer EquipCB04a;
    private final ModelRenderer EquipCB04b;
    ...
    public ModelBattleshipRu() {
        ...
        this.scale = 0.44f;
        this.offsetY = 1.9f;
        this.offsetItem = new float[]{0.07f, 1.0f, -0.07f};
        this.offsetBlock = new float[]{0.07f, 1.0f, -0.07f};
        this.setDefaultFaceModel();
        this.GloveL = new ModelRenderer(this, 2, 34);
        this.GloveL.setRotationPoint(-3.0f, 0.0f, -3.0f);
        this.GloveL.addBox(-2.5f, 5.5f, -2.5f, 6, 7, 6, 0.0f);
        this.GloveR = new ModelRenderer(this, 2, 34);
        this.GloveR.setRotationPoint(-3.0f, 0.0f, -3.0f);
        this.GloveR.addBox(2.5f, 5.5f, -2.5f, 6, 7, 6, 0.0f);
        ...
        this.setRotateAngle(this.LegRight01, -0.13962634f, 0.0f, -0.08726646f);
        ...
        this.setRotateAngle(this.EquipL04a, 0.08726646f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipLC01a, 0.13962634f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipL06b, 0.34906584f, -0.6981317f, -0.2617994f);
        ...
        this.setRotateAngle(this.EquipCB02a, 0.5235988f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipCB04b, 0.61086524f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipR04a, 0.08726646f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipL08, -0.13962634f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipRC03b, 0.10471976f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.Equip03b, -0.43633232f, 0.2617994f, -0.7853982f);
        ...
        this.setRotateAngle(this.EquipCB03, -0.34906584f, 0.34906584f, -0.43633232f);
        ...
        this.setRotateAngle(this.EquipR03a, -0.2268928f, -0.13962634f, 0.0f);
        ...
        this.setRotateAngle(this.EquipR02a, -0.5235988f, -0.17453292f, 0.0f);
        ...
        this.setRotateAngle(this.EquipCB01, -0.34906584f, -0.34906584f, 0.43633232f);
        ...
        this.setRotateAngle(this.EquipR06a, 0.34906584f, 0.6981317f, 0.2617994f);
        ...
        this.setRotateAngle(this.EquipL04b, 0.08726646f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipL05b, 0.2617994f, 0.2617994f, 0.0f);
        ...
        this.setRotateAngle(this.EquipLC01b, -0.05235988f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipR04b, 0.08726646f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipLC03a, -0.17453292f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipR02b, -0.5235988f, 0.17453292f, 0.0f);
        ...
        this.setRotateAngle(this.EquipLC02b, (float)Math.PI / 90, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipCB02b, 0.87266463f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.Ahoke, -0.08726646f, 0.0f, 0.13665928f);
        ...
        this.setRotateAngle(this.EquipR01, 0.0f, -1.5707964f, 0.0f);
        ...
        this.setRotateAngle(this.EquipR09, 0.31415927f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipL06a, 0.34906584f, 0.6981317f, 0.2617994f);
        ...
        this.setRotateAngle(this.EquipR05a, 0.2617994f, -0.2617994f, 0.0f);
        ...
        this.setRotateAngle(this.EquipRC02b, (float)Math.PI / 90, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipRC01a, 0.13962634f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipR05b, 0.2617994f, 0.2617994f, 0.0f);
        ...
        this.setRotateAngle(this.EquipRC01b, -0.05235988f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.HairL01, -0.08726646f, -0.07f, 0.05235988f);
        ...
        this.setRotateAngle(this.EquipL10, 0.17453292f, 0.17453292f, 0.0f);
        ...
        this.setRotateAngle(this.EquipL02a, -0.5235988f, -0.17453292f, 0.0f);
        ...
        this.setRotateAngle(this.EquipRC03c, 0.13962634f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipLC03b, 0.10471976f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipRC03a, -0.17453292f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipL07, -0.08726646f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipCB04a, 0.7853982f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipLC03c, 0.13962634f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.HairL02, 0.12217305f, 0.0f, -0.08726646f);
        this.ArmRight01 = new ModelRenderer(this, 24, 84);
        this.ArmRight01.mirror = true;
        this.ArmRight01.setRotationPoint(-7.8f, -9.0f, -0.7f);
        this.ArmRight01.addBox(-3.0f, -1.0f, -2.5f, 5, 12, 5, 0.0f);
        this.setRotateAngle(this.ArmRight01, 0.0f, 0.43633232f, 0.34906584f);
        ...
        this.setRotateAngle(this.EquipR06b, 0.34906584f, -0.6981317f, -0.2617994f);
        ...
        this.setRotateAngle(this.EquipR10, 0.17453292f, -0.17453292f, 0.0f);
        ...
        this.setRotateAngle(this.EquipL09, 0.31415927f, 0.0f, 0.0f);
        this.ArmLeft01 = new ModelRenderer(this, 24, 84);
        this.ArmLeft01.setRotationPoint(7.8f, -9.0f, -0.7f);
        this.ArmLeft01.addBox(-2.0f, -1.0f, -2.5f, 5, 12, 5, 0.0f);
        this.setRotateAngle(this.ArmLeft01, 0.22759093f, -0.43633232f, -0.34906584f);
        ...
        this.setRotateAngle(this.HairR01, -0.08726646f, 0.07f, -0.05235988f);
        ...
        this.setRotateAngle(this.EquipL01, 0.0f, -1.5707964f, 0.0f);
        ...
        this.setRotateAngle(this.EquipLC04a, 0.13962634f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipR08, -0.13962634f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipR07, -0.08726646f, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.Equip03a, -0.43633232f, -0.2617994f, 0.7853982f);
        ...
        this.setRotateAngle(this.EquipRC01c, (float)Math.PI / 90, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipL05a, 0.2617994f, -0.2617994f, 0.0f);
        ...
        this.setRotateAngle(this.EquipR03b, -0.2268928f, 0.13962634f, 0.0f);
        ...
        this.setRotateAngle(this.EquipL03a, -0.2268928f, -0.13962634f, 0.0f);
        ...
        this.setRotateAngle(this.Equip01b, 0.0f, 0.17453292f, 0.34906584f);
        ...
        this.setRotateAngle(this.EquipL02b, -0.5235988f, 0.17453292f, 0.0f);
        ...
        this.setRotateAngle(this.Equip01a, 0.0f, -0.17453292f, -0.34906584f);
        ...
        this.setRotateAngle(this.EquipLC01c, (float)Math.PI / 90, 0.0f, 0.0f);
        ...
        this.setRotateAngle(this.EquipL03b, -0.2268928f, 0.13962634f, 0.0f);
        ...
        this.setRotateAngle(this.EquipRC04a, 0.13962634f, 0.0f, 0.0f);
    ...
    public void showEquip(IShipEmotion ent) {
        ...
        this.EquipLBase.isHidden = flag = !EmotionHelper.checkModelState(0, state);
        this.EquipRBase.isHidden = flag;
        this.EquipBase.isHidden = !EmotionHelper.checkModelState(1, state);
        this.GloveL.isHidden = flag = !EmotionHelper.checkModelState(2, state);
    ...
    public void applyDeadPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
        GlStateManager.translate(0.0f, 0.66f, 0.0f);
    ...
    public void applyNormalPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
        ...
        boolean showWeapon = EmotionHelper.checkModelState(0, ent.getStateEmotion(0));
        ...
        if (ent.getStateEmotion(1) == 4 && showWeapon && t2 > 400.0f) {
            spStand = true;
            this.setFace(1);
            ...
            this.BodyMain.rotateAngleY = 0.0f;
            this.BodyMain.rotateAngleZ = 0.0f;
            this.Head.rotateAngleX -= 0.18203785f;
            this.ArmLeft01.rotateAngleX = -1.0471976f;
            this.ArmLeft01.rotateAngleY = 0.0f;
            this.ArmLeft01.rotateAngleZ = -0.34906584f;
            this.ArmRight01.rotateAngleX = -1.0471976f;
            this.ArmRight01.rotateAngleY = 0.0f;
        ...
        if (ent.getIsSitting() || ent.getIsRiding()) {
            ...
            if (ent.getStateEmotion(1) == 4) {
                ...
                this.BodyMain.rotateAngleX = -0.10471976f;
                this.BodyMain.rotateAngleY = -0.34906584f;
                this.BodyMain.rotateAngleZ = 0.0f;
                this.Head.rotateAngleY -= 0.5235988f;
                this.ArmLeft01.rotateAngleX = 0.87266463f;
                this.ArmLeft01.rotateAngleY = 0.0f;
                this.ArmLeft01.rotateAngleZ = -0.34906584f;
                this.ArmLeft02.rotateAngleX = -0.7853982f;
                this.ArmLeft02.rotateAngleY = 0.0f;
                this.ArmLeft02.rotateAngleZ = 0.0f;
                this.ArmRight01.rotateAngleX = -0.43633232f;
                this.ArmRight01.rotateAngleY = 0.0f;
                this.ArmRight01.rotateAngleZ = 0.34906584f;
                this.ArmRight02.rotateAngleX = -0.87266463f;
                ...
                this.LegLeft01.rotateAngleY = 0.0f;
                this.LegLeft01.rotateAngleZ = 0.08726646f;
                this.LegLeft02.rotateAngleX = 1.3962634f;
                this.LegLeft02.rotateAngleY = 0.0f;
                this.LegLeft02.rotateAngleZ = 0.0f;
                this.LegRight01.rotateAngleY = 0.0f;
                this.LegRight01.rotateAngleZ = -0.08726646f;
                ...
                this.LegRight02.rotateAngleY = 0.0f;
                this.LegRight02.rotateAngleZ = 0.0f;
            } else if (ent.getStateEmotion(7) == 4 && showWeapon) {
                GlStateManager.translate(0.0f, 0.52f, 0.0f);
                this.BodyMain.rotateAngleX = 0.7853982f;
                this.Butt.rotateAngleX = 0.2617994f;
                this.Head.rotateAngleX = 0.5235988f;
                this.Hair01.rotateAngleX = -0.34906584f;
                this.Hair02.rotateAngleX = -0.12217305f;
                this.ArmLeft01.rotateAngleX = 2.6179938f;
                this.ArmLeft01.rotateAngleY = 0.0f;
                this.ArmLeft01.rotateAngleZ = 0.0f;
                this.ArmRight01.rotateAngleX = 2.6179938f;
                this.ArmRight01.rotateAngleY = 0.0f;
                ...
                this.LegRight01.rotateAngleY = 0.0f;
                this.LegRight01.rotateAngleZ = -0.08726646f;
                this.LegRight02.rotateAngleX = 0.2617994f;
                this.LegRight02.rotateAngleY = 0.0f;
                this.LegRight02.rotateAngleZ = 0.0f;
                this.EquipLBase.rotateAngleX = 1.2217305f;
                this.EquipLBase.rotateAngleY = 0.0f;
                this.EquipLBase.rotateAngleZ = 0.0f;
                this.EquipRBase.rotateAngleX = 1.2217305f;
                this.EquipRBase.rotateAngleY = 0.0f;
                this.EquipRBase.rotateAngleZ = 0.0f;
            } else if (!this.EquipLBase.isHidden) {
                GlStateManager.translate(0.0f, 0.2f, 0.0f);
                this.BodyMain.rotateAngleX = 0.18203785f;
                this.Butt.rotateAngleX = 0.2617994f;
                this.Head.rotateAngleX -= 0.20943952f;
                this.ArmLeft01.rotateAngleX = 0.13962634f;
                this.ArmLeft01.rotateAngleY = 0.0f;
                this.ArmLeft01.rotateAngleZ = -0.34906584f;
                this.ArmRight01.rotateAngleX = -1.1838568f;
                ...
                this.LegRight02.rotateAngleZ = 0.0f;
                this.EquipLBase.rotateAngleX = 0.0f;
                this.EquipLBase.rotateAngleY = -1.5707964f;
                this.EquipLBase.rotateAngleZ = 0.31415927f;
                this.EquipRBase.rotateAngleX = 0.7285004f;
                this.EquipRBase.rotateAngleY = 0.0f;
                this.EquipRBase.rotateAngleZ = 0.0f;
            } else {
                ...
                this.BodyMain.rotateAngleX = 0.27314404f;
                this.Butt.rotateAngleX = 0.2617994f;
                this.Head.rotateAngleX -= 0.41887903f;
                this.ArmLeft01.rotateAngleX = 0.091106184f;
                this.ArmLeft01.rotateAngleY = 0.0f;
                this.ArmLeft01.rotateAngleZ = -0.63739425f;
                this.ArmLeft02.rotateAngleX = 0.0f;
                this.ArmLeft02.rotateAngleY = 0.0f;
                this.ArmLeft02.rotateAngleZ = 1.3658947f;
                this.ArmRight01.rotateAngleX = -0.85f;
                this.ArmRight01.rotateAngleY = 0.0f;
                this.ArmRight01.rotateAngleZ = 0.0f;
                this.ArmRight02.rotateAngleX = 0.0f;
                this.ArmRight02.rotateAngleY = 0.0f;
                this.ArmRight02.rotateAngleZ = -0.5009095f;
                addk1 = -1.2747885f;
                addk2 = -2.1399481f;
                this.LegLeft01.rotateAngleY = 0.0f;
                this.LegLeft01.rotateAngleZ = 0.08726646f;
                this.LegLeft02.rotateAngleX = 2.321986f;
                this.LegLeft02.rotateAngleY = 0.0f;
                this.LegLeft02.rotateAngleZ = 0.0f;
                this.LegLeft02.offsetZ = 0.375f;
                this.LegRight01.rotateAngleY = 0.0f;
                this.LegRight01.rotateAngleZ = -0.08726646f;
                this.LegRight02.rotateAngleX = 1.5707964f;
                this.LegRight02.rotateAngleY = 0.0f;
                this.LegRight02.rotateAngleZ = 0.0f;
            }
        }
        if (ent.getAttackTick() > 0) {
            ...
            this.Butt.rotateAngleX = 0.35f;
            if (showWeapon) {
                this.ArmLeft02.rotateAngleX = -0.87266463f;
                this.ArmRight02.rotateAngleX = -0.87266463f;
            } else {
                this.ArmLeft02.rotateAngleX = 0.0f;
                this.ArmRight02.rotateAngleX = 0.0f;
            ...
            this.ArmRight01.rotateAngleY = 0.5235988f;
            ...
            addk2 = angleAdd2 * 0.5f - 0.21f;
            this.EquipLBase.rotateAngleX = 0.0f;
            this.EquipLBase.rotateAngleY = -0.2617994f;
            this.EquipLBase.rotateAngleZ = 0.34906584f;
            this.EquipRBase.rotateAngleX = 0.0f;
            this.EquipRBase.rotateAngleY = 0.2617994f;
            this.EquipRBase.rotateAngleZ = -0.34906584f;
        }
