...
extends ShipModelBaseAdv {
    ...
    private final ModelRenderer Hair01a;
    ...
    public ModelBBHiei() {
        ...
        this.setRotateAngle(this.Hair02a, 0.12217305f, 0.20943952f, -0.9599311f);
        ...
        this.setRotateAngle(this.Hair01a, 0.12217305f, -0.20943952f, 0.9599311f);
        ...
        this.setRotateAngle(this.Hair01, 0.5061455f, 0.0f, 0.0f);
    ...
    public void applyDeadPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
        switch (ent.getScaleLevel()) {
            ...
            case 1: {
                GlStateManager.translate(0.0f, 0.89f, 0.0f);
                break;
            }
            default: {
    ...
    public void applyNormalPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
        ...
        if (ent.getIsSitting() || ent.getIsRiding()) {
            ...
            if (ent.getTickExisted() % 512 > 256) {
                ...
                switch (ent.getScaleLevel()) {
                    case 3: {
                        GlStateManager.translate(0.0f, 1.11f, 0.0f);
                        break;
                    }
                    case 2: {
                        GlStateManager.translate(0.0f, 0.99f, 0.0f);
                        break;
                    }
                    case 1: {
                        GlStateManager.translate(0.0f, 0.81f, 0.0f);
                        break;
                    }
                    default: {
                ...
                if (parTick < 30.0f) {
                    az = MathHelper.sin(parTick * 0.033f * 1.5708f);
                    this.setFace(3);
                    this.ArmLeft01.rotateAngleZ = 0.1f + az * 1.8f;
                    this.ArmLeft02.rotateAngleZ = 1.0f - az * 2.88f;
                    ...
                    this.ArmRight01.rotateAngleZ = -this.ArmLeft01.rotateAngleZ;
                    this.ArmRight02.rotateAngleZ = -this.ArmLeft02.rotateAngleZ;
                    this.ClothA03.rotateAngleY = 0.7f + az * -2.0f;
                    this.ClothA03.offsetX = -0.2f + az * 0.73f;
                    this.ClothA03a.rotateAngleY = -this.ClothA03.rotateAngleY;
                    this.ClothA03a.offsetX = -this.ClothA03.offsetX;
                    addCA031 = 0.0f;
