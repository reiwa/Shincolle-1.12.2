...
import com.lulan.shincolle.client.model.ModelBlockDeskLarge;
...
public class RenderDesk extends TileEntitySpecialRenderer<BasicTileEntity> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation("shincolle:textures/blocks/blockdesk.png");

    private final ModelBlockDesk modelSingle = new ModelBlockDesk();
    private final ModelBlockDeskLarge modelDouble = new ModelBlockDeskLarge();
    ...
    private boolean canConnectTo(World world, BlockPos pos, EnumFacing direction, Block requiredBlock, int requiredMeta) {
        ...
        if (neighborState.getBlock() == requiredBlock) {
            ...
            if (neighborTe instanceof TileEntityDesk) {
