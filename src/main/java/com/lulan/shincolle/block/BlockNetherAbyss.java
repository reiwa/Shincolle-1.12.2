...
public class BlockNetherAbyss extends BasicBlock {
    public static final String MODID = "shincolle";
    public static final String NAME = "BlockNetherAbyss";
    public static final BlockNetherAbyss INSTANCE = new BlockNetherAbyss();
    private static final Random rand = new Random();

    public BlockNetherAbyss() {
        super(Material.IRON);
    ...
    public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
        ...
        int nuggetCount = quantityDroppedWithBonus(fortune, rand);
        drops.add(new ItemStack(ModItems.AbyssNugget, nuggetCount, damageDropped(state)));
        drops.add(new ItemStack(ModItems.Grudge, 1));
        return drops;
    }
